// tag::FEEDBACK[]
:filename: 06-Prioritization/01-duration-terms.adoc
...
// tag::EN[]
|===
| Lesson duration: 45 min | Exercises: 30 min
|===
...
Business value, risk, ranking, prioritization, affinity estimation, wall estimation, story points, WSJF
