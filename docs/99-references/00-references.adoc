...
- [[[hohmann,Hohmann]]] Hohmann, Luke: Innovation Games: Creating Breakthrough Products Through Collaborative Play. Addison-Wesley, 2006 (origin of the Product Box / Product Vision Box technique)
- [[[hruschka,Hruschka]]] Hruschka, Peter: Business Analysis und Requirements Engineering, Hanser Verlag, 4th Edition 2026 (in German)
...
- [[[pichler-visionboard,Pichler-VisionBoard]]] Pichler, Roman: The Product Vision Board. https://www.romanpichler.com/tools/product-vision-board/
