...
* Das Konzept architekturrelevanter Anforderungen (ASR) verstehen und dass Architekt:innen sich auf diese konzentrieren sollten statt auf Vollständigkeit
...
* Understand the concept of architecturally significant requirements (ASR), and that architects should concentrate on them rather than on completeness
