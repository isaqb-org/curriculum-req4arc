// tag::FEEDBACK[]
:filename: 01-Intro-and-Motivation/LG-1-02.adoc
...
* Know that there are different job title for persons responsible for requirements (Business Analysts, Requirements Engineers, Product Owner)
