...
* Techniken zur Konfliktlösung kennen, z.B. Priorisierung (siehe <<LZ-8-2>>), Trade-off- und Utility-Analyse, Eskalation an Entscheidungsträger sowie direkte Verhandlung mit den betroffenen Stakeholdern
...
* Know techniques for conflict resolution, e.g. prioritization (see <<LG-8-2>>), trade-off and utility analysis, escalation to decision makers, and direct negotiation with the affected stakeholders
