...
* Know the `Given-When-Then syntax, e.g. as proposed by Gherkin.
* Know that Given-When-Then based formulation of requirements facilitates test automation.
* Know that several tools exist to map Given-When-Then behavior specifications to the systems' source code (Cucumber, RSpec, SpecFlow, GivWenZen).
