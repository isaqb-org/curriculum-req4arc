...
* Verstehen, dass Visionen oder Business Goals die obersten Anforderungen sind, also jene, die sich (hoffentlich) während eines Projekts nicht ändern
...
* Merkhilfen für Vision- oder Zielformulierungen kennen (SMART, PAM)
...
* Wissen, dass eine priorisierte Stakeholder-Liste hilft, Anforderungen nach Business Value zu priorisieren
* Wissen, dass Architekt:innen Zielkonflikte zwischen den Bedürfnissen der Stakeholder behandeln müssen
