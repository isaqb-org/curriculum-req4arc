...
Auch wenn Requirements Engineering heute iterativ und inkrementell erfolgen sollte, braucht es einige Vorab-Aktivitäten, die die detaillierte Anforderungsermittlung und zentrale Architekturentscheidungen leiten.
Sie bilden den „Clean Start" einer Projekt- oder Produktentwicklung.
