...
* Wissen, dass unterschiedliche Stile der Erhebung und Spezifikation von Qualitäten bei verschiedenen Stakeholdern schneller oder langsamer zu Ergebnissen führen können.
